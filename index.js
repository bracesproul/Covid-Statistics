...
const getData = async (total_cases, total_deaths, current_hospitalized, current_icu, cases, deaths, death_rate_7, cumulative_death_rate, new_tests, vaccines_administered, people_fully_vaccinated) => {
    ...
    final.push(finalObj_total_cases, finalObj_total_deaths, finalObj_current_hospitalized, finalObj_current_icu, finalObj_cases, finalObj_deaths, finalObj_death_rate_7, finalObj_cumulative_death_rate, finalObj_new_tests, finalObj_vaccines_administered, finalObj_people_fully_vaccinated);
    console.log(final);
}
